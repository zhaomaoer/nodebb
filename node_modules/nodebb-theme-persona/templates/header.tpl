...
<title> {browserTitle}</title>
	...
	<!--[if lt IE 9]>
  		...
  		<script>__lt_ie_9__ = 1;</script>ss
	<![endif]-->
...
<body>
	...
	<main id="panel">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top header" role="navigation" id="header-menu" component="navbar">
			<div class="container" ><!-- IMPORT partials/menu.tpl -->
			</div>
		</nav>
<!-- IF breadcrumbs.length -->
<!-- ENDIF breadcrumbs.length -->
				<div class="container" >
 <a class="btn btn-default navbar-fixed-bottom" href="{relative_path}/user/{user.username}" role="button">{user.username}</a>
 </div>
