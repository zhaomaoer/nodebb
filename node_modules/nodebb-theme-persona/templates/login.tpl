...
<div class="row" id="login-all" style="display:none">
	<!-- IF allowLocalLogin -->
		...
		<div class="well well-lg" >
			...
			<form class="form-horizontal" role="form" method="post" target="login" id="login-form"  >
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input  class="form-control"  name="username" id="username" autocorrect="off" autocapitalize="off" value="{openid}"/>  
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input  class="form-control" type="password" value="{password}" placeholder="[[user:password]]" name="password" id="password" />
					</div>
				</div>
				<div class="form-group">
